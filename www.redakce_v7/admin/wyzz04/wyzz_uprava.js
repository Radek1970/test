...
var buttonNameCZ = new Array("tuèné","italic","podtržené","pøeškrtnuté","separator","vyjmout","copy","paste","separator","barva písma","barva pozadí","separator","dolní index","horní index","separator","zarovnat vlevo","zarovnat na støed","zarovnat do prava","indent","outdent","separator");

var buttonName2CZ = new Array("seznam odrážky","seznam èísla","písmo zoom plus","písmo zoom mínus","odkaz","zpìt","vpøed","separator","html kód","separator","pomoc");
