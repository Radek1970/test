...
// Images Directory
imagesDir = "editor5/icons/";

// CSS Directory
cssDir = "editor5/styles/";

// Popups Directory
popupsDir = "editor5/popups/";
...
var buttonName = new Array();
  ...
  buttonName[4]  = "seperator";
	...
	// Order of available commands in toolbar one
var buttonName1 = new Array();
  buttonName1[0]  = "seperator";
	buttonName1[1]  = "justifyleft";
	buttonName1[2]  = "justifycenter";
	buttonName1[3] = "justifyright";
	buttonName1[4] = "seperator";
	buttonName1[5] = "unorderedlist";
	buttonName1[6] = "orderedlist";	
//	buttonName1[7] = "outdent";
//	buttonName1[8] = "indent";
	buttonName1[9]  = "seperator";
	buttonName1[10]  = "forecolor";
	buttonName1[11]  = "backcolor";
	//buttonName1[12]  = "seperator";
	//buttonName1[13]  = "cut";
...
function generate_wysiwyg(textareaID) {
  ...
  var toolbar;
  /**
  toolbar =  '<div id="toolbar_menu"><table cellpadding="0" cellspacing="0" border="0" class="toolbar1" style="width:' + toolbarWidth + 'px;"><tr><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
...
// Output all command buttons that belong to toolbar one
	for (var s = 0; s <= buttonName1.length;) { 
    if (buttonName1[s]) {
	    var buttonObj            = ToolbarList[buttonName1[s]];
		  var buttonID             = buttonObj[0];
	    var buttonTitle          = buttonObj[1];
      var buttonImage          = buttonObj[2];
		  var buttonImageRollover  = buttonObj[3];
	    
			if (buttonName1[s] == "seperator") {
		    toolbar += '<td style="width: 12px;" align="center"><img src="' +buttonImage+ '" border=0 unselectable="on" width="2" height="18" hspace="2" unselectable="on"></td>';
			}
	    else {
		    toolbar += '<td style="width: 22px;"><img src="' +buttonImage+ '" border=0 unselectable="on" title="' +buttonTitle+ '" id="' +buttonID+ '" class="button" onClick="formatText(this.id,\'' + n + '\');" onmouseover="if(className==\'button\'){className=\'buttonOver\'}; this.src=\'' + buttonImageRollover + '\';" onmouseout="if(className==\'buttonOver\'){className=\'button\'}; this.src=\'' + buttonImage + '\';" unselectable="on" width="20" height="20"></td>';
