<?php
 ...
 include_once('session/session_end.php');
?>
...
?>    
  ...
  <div id="main_content"> 
     ...
     <?php
      // pripojeni funkce pro odeslani hesla na zadany eimal
      send_password($email);
         
			// pripojeni sekce panel vstup..
      include_once('komponenty/formular.php');
      ?>           
