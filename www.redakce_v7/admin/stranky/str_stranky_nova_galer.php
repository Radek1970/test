...
// piktogram stranky
echo "<img src=\"css/images/fotka_big.png\" />";       



$form = '<form id="myform" class="cssform" action="page.php?akc=stranky" method="post">
<input type="hidden" name="galerie" value="ano"/>
<input type="hidden" name="formular_kontakt" value="ne" />

       <div class="contact_tab">	
                    <div class="form_contact">
                    
                    <div class="form_row_contact">
                    <label class="left">Název odkazu galerie: </label>
