...
/*  
PHP Data Objects (PDO) je konzistentní rozhraní pro přístup k databázím v PHP. 
PDO - automatické zabezpečení parametrů (proměnných) v dotazech.
*/
...
/**
	...
	private static function executeStatement($params)
	{
		...
		$statement = self::$spojeni->prepare($query);
	...
	{
		return self::$spojeni->quote($string);
	}
